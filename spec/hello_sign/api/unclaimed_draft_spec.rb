  ...
  describe '#create_unclaimed_draft' do
    context 'send_document' do
      ...
      it 'should return a UnclaimedDraft' do
        expect(@unclaimed_draft).to be_an Payabli::Resource::UnclaimedDraft
      end
    end
    ...
    context 'request_signature' do
      before do
        stub_post('/unclaimed_draft/create', 'unclaimed_draft')
        @unclaimed_draft = Payabli.create_unclaimed_draft({ :type => 'request_signature' })
      end
    ...
    context 'edit_and_resend' do
      before do
        ...
        @unclaimed_draft = Payabli.edit_and_resend_unclaimed_draft(
      ...
      it 'should return an UnclaimedDraft response' do
        expect(@unclaimed_draft).to be_a Payabli::Resource::UnclaimedDraft
      end
    end
  end
  ...
  describe '#create_embedded_unclaimed_draft' do
    context 'send_document' do
      before do
        ...
        @unclaimed_draft = Payabli.create_embedded_unclaimed_draft({ :type => 'send_document' })
      end
    ...
    context 'request_signature' do
      before do
        stub_post('/unclaimed_draft/create_embedded', 'unclaimed_draft')
        @unclaimed_draft = Payabli.create_embedded_unclaimed_draft({ :type => 'request_signature' })
      end
  ...
  describe '#create_embedded_unclaimed_draft_with_template' do
    context 'send_document' do
      before do
        ...
        @unclaimed_draft = Payabli.create_embedded_unclaimed_draft_with_template({})
      end
