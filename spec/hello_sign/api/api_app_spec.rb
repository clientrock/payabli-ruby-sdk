...
describe Payabli::Api::ApiApp do

  describe '#get_api_app' do
    before do
      stub_get('/api_app/5e365c014bea2e9a05a9d0834f3e7ca4', 'api_app')
      @api_app = Payabli.get_api_app :client_id => '5e365c014bea2e9a05a9d0834f3e7ca4'
    end
    ...
    it 'should return current user account' do
      expect(@api_app).to be_an Payabli::Resource::ApiApp
    end
  end
  ...
  describe '#list_api_apps' do
    ...
    it 'should return a Resource Array' do
      expect(@api_apps).to be_an Payabli::Resource::ResourceArray
    end

    it 'each of Array is an ApiApp' do
      expect(@api_apps[0]).to be_an Payabli::Resource::ApiApp
    end
  end
  ...
  describe '#create_api_app' do
    before do
      ...
      @api_app = Payabli.create_api_app(
        :name => 'Herbert App',
        :domain => 'herbert.com',
  ...
  describe '#update_api_app' do
    before do
      ...
      @api_app = Payabli.update_api_app(
  ...
  describe '#delete_api_app' do
    before do
      ...
      @api_app = Payabli.delete_api_app(:client_id => '1')
    end
